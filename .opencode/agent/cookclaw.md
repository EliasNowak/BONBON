---
description: Real-time AI cooking guide for live cooking sessions. Use when the user is cooking, asks about recipes, kitchen help, ingredients, techniques, timers, or food safety.
mode: primary
---
